...
public final class CaptureActivity extends Activity implements
	...
	/**
	 * ������������ֻ�û�����ӵ�Դ�ߣ���ô������������һֱ���ڲ���ʹ��״̬��÷���Ὣ��ǰactivity�رա�
	 * ������ȫ�̼��ɨ���Ծ״̬����CaptureActivity����������ͬ.ÿһ��ɨ���󶼻����øü�أ������µ���ʱ��
	 */
	private InactivityTimer inactivityTimer;

	/**
	 * �����𶯹����������ɨ��ɹ�����Բ���һ����Ƶ��Ҳ���������ѣ�����ͨ������������ɨ��ɹ������Ϊ��
	 */
	...
	/**
	 * ���������Ĳ���(����MultiFormatReader�Ĳ���)�� �������ͣ��ò������ɨ�������ú��ֱ��뷽ʽ���룬��EAN-13��QR
	 * Code�ȵ� ��Ӧ��DecodeHintType.POSSIBLE_FORMATS����
	 * �ο�DecodeThread���캯�������´��룺hints.put(DecodeHintType.POSSIBLE_FORMATS,
	 * decodeFormats);
	 */
	private Collection<BarcodeFormat> decodeFormats;

	/**
	 * ���������Ĳ���(����MultiFormatReader�Ĳ���)�� �ò������ջᴫ��MultiFormatReader��
	 * �����decodeFormats��characterSet���ջ��ȼ��뵽decodeHints�� ���ձ����õ�MultiFormatReader��
	 * �ο�DecodeHandler�����������´��룺multiFormatReader.setHints(hints);
	 */
	private Map<DecodeHintType, ?> decodeHints;

	/**
	 * ���������Ĳ���(����MultiFormatReader�Ĳ���)�� �ַ�����ɨ�������Ժ����ַ���н���
	 * ��Ӧ��DecodeHintType.CHARACTER_SET����
	 * �ο�DecodeThread���������´��룺hints.put(DecodeHintType.CHARACTER_SET,
	 * characterSet);
	 */
